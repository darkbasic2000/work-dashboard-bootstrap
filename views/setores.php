...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Work Dashboard - Setores</title>
        ...
        <div class="container w-75">            
            ...
            <div class="row mt-3">
                <div class="col-6 text-center">
                    <i class="bi bi-building" style="font-size: 12rem;"></i>
                </div>
                <div class="col-6">
                    <form class="mt-5">
                        <input type="hidden" id="csrf_token" value="<?= $_SESSION['csrf_token'] ?>" />
                        <div class="mb-3">
                            <label class="mb-2">Novo Setor</label>
                            <input type="text" id="nome" class="form-control" maxlength="30" />
                        </div>                        
                        <div class="mb-3 text-end">
                            <button id="salvar" class="btn btn-success mb-2" type="button">
